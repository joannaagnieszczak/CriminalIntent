...
class CrimeDetailFragment: Fragment() {
    ...
    ){didTakePhoto: Boolean -> if (didTakePhoto && photoName != null){
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            val selectSuspectIntnt = selectSuspect.contract.createIntent(
                requireContext(),
                null)
            crimeSuspect.isEnabled = canResolveIntent(selectSuspectIntnt)
